...
object SNerPipeline {
  ...
  /**
    ...
    * You can replace default models by providing your own list of models.
    ...
    * @param nerPath path to a comma delimited list of models, if passed, it will be used instead of default CoreNLP models
    * @return
    */
